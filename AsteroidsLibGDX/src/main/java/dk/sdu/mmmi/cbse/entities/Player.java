...
public class Player extends SpaceObject {
    ...
    private void setFlame(){
        flamex[0] = x + MathUtils.cos(radians - 5 * 3.1314f / 6) * 5;
        flamey[0] = y + MathUtils.sin(radians - 5 * 3.1314f / 6) * 5;
        ...
        flamex[2] = x + MathUtils.cos(radians + 5 * 3.1314f / 6) * 5;
        flamey[2] = y + MathUtils.sin(radians + 5 * 3.1314f / 6) * 5;
    }
    ...
    public void shoot(){
        ...
        bullets.add(new Bullet(x, y, radians, false));
    }
